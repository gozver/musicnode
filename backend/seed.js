...
const bands = [{
  name: 'band1', description: 'description1', phone: '123-456-789', email: 'band1@gmail.com', avatar: 'user.png',
  price: 1, type: 'rock', scope: 'andalucia', video: null, roleId: 1
}, {
  name: 'band2', description: 'description2', phone: '123-456-789', email: 'band2@gmail.com', avatar: 'user.png', 
  price: 1, type: 'rock', scope: 'andalucia', video: null, roleId: 1
}]

const companies = [{ 
  name: 'company1', description: 'description1', phone: '123-456-789', email: 'company1@gmail.com', 
  avatar: 'user.png', address: 'false street 123', roleId: 2
}, {
  name: 'company2', description: 'description2', phone: '123-456-789', email: 'company2@gmail.com',
  avatar: 'user.png', address: 'false street 123', roleId: 2
}];
...
sequelize.sync({ force: true })
  ...
  // insert bands
  .then(() => bands.forEach(band => models.ad.create(band)))
  // insert companies
  .then(() => companies.forEach(company => models.ad.create(company)));
