...
const review = [
  ...
  { body: reviewIn2, rating: 4, userId: 2, bandId: 1 },
  ...
  { body: reviewIn3, rating: 5, userId: 1, bandId: 4 },
  { body: reviewIn4, rating: 4, userId: 2, bandId: 4 },
  { body: reviewIn1, rating: 4, userId: 3, bandId: 5 },
  { body: reviewIn2, rating: 5, userId: 4, bandId: 5 },
  { body: reviewIn3, rating: 4, userId: 5, bandId: 6 },
  { body: reviewIn4, rating: 3, userId: 6, bandId: 6 },

  { body: reviewIn1, rating: 5, userId: 1, bandId: 7 },
  { body: reviewIn2, rating: 4, userId: 2, bandId: 7 },
  { body: reviewIn3, rating: 4, userId: 3, bandId: 8 },
  { body: reviewIn4, rating: 5, userId: 4, bandId: 8 },
  { body: reviewIn1, rating: 4, userId: 5, bandId: 9 },
  { body: reviewIn2, rating: 3, userId: 6, bandId: 9 },

  { body: reviewIn3, rating: 5, userId: 1, bandId: 10 },
  { body: reviewIn4, rating: 4, userId: 2, bandId: 10 },
