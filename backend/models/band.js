...
Band.init({
  ...
  name:   { type: DataTypes.STRING,  allowNull: true,  validate: { notEmpty: false } },
  desc:   { type: DataTypes.TEXT,    allowNull: true,  validate: { notEmpty: false } },
  phone:  { type: DataTypes.STRING,  allowNull: true,  validate: { notEmpty: false } },
  ...
  email:  { type: DataTypes.STRING,  allowNull: true,  validate: { notEmpty: true, isEmail: true }, unique: true },
