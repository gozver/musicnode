...
const adminUsers = require('./data/adminUser');
const adminUserRoles = require('./data/adminUserRole');
const contractorUsers = require('./data/contractorUser');
const contractorUserRoles = require('./data/contractorUserRole');
const musicianUsers = require('./data/musicianUser');
const musicianUserRoles = require('./data/musicianUserRole');
const bands = require('./data/band');
const bandUsers = require('./data/bandUser');
const bandUserRoles = require('./data/bandUserRole');
const companies = require('./data/company');
const companyUsers = require('./data/companyUser');
const companyUserRoles = require('./data/companyUserRole');
